...
# File paths
readonly COLLECTION_FILE_NAME="Fullstack-Project-API.postman_collection.json"
readonly ENVIRONMENT_FILE_NAME="Fullstack-Project-Environment.postman_environment.json"
...
get_project_name() {
    ...
    if [ -z "$project_name" ]; then
        project_name="Fullstack-Project"
    fi
...
find_file() {
    ...
    local search_paths=(
        ...
        "$PROJECT_ROOT/scripts/postman/$filename"
        "scripts/postman/$filename"
        "../../scripts/postman/$filename"
    )
...
show_usage() {
    ...
    echo ""
    echo "Upload Fullstack Project API Postman collection and environment to cloud workspace."
    echo ""
    echo "Arguments:"
    ...
    echo "  - Fullstack-Project-API.postman_collection.json (complete API collection)"
    echo "  - Fullstack-Project-Environment.postman_environment.json (environment variables)"
    echo ""
...
main() {
    # Show header
    print_info "Fullstack Project API Postman Upload Script v2.0"
    echo "====================================================="
    echo "This will upload the complete API collection and environment to Postman"
    echo "Collection includes: Auth, User, Carrier, Customer, Pricing, and Translation services"
    echo ""
