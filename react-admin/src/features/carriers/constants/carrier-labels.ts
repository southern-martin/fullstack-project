/**
 * Carrier Module - Centralized Label Constants
 * 
 * This file contains all static UI text labels for the Carrier module.
 ...
 */
export const CARRIER_LABELS: CarrierLabels = {
  page: {
    title: 'Carriers',
