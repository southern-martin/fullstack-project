...
import { customerDemographicsData, monthlySalesData, revenueTrendData } from '../data/chartData';
        ...
        <div className="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div className="flex items-center gap-3">
                    <button className="flex items-center justify-center rounded-md border border-stroke bg-white px-4 py-2 text-xs font-medium text-black hover:bg-gray-100 dark:border-strokedark dark:bg-boxdark dark:text-white dark:hover:bg-boxdark">
                        Purchase Plan
                    </button>
                </div>
            </div>
                        ...
                        <div key={stat.name} className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
                            ...
                            <div className="mt-5 flex items-end justify-between">
                                <div>
                                    ...
                                    <h4 className="mt-2 text-base font-bold text-gray-800 dark:text-white/90">
                                        {stat.value}
                                    </h4>
                                </div>
                                <span className={`flex items-center gap-1 rounded-full py-0.5 pl-2 pr-2.5 text-xs font-medium ${stat.changeType === 'increase' ? 'bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500' : 'bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500'}`}>
            ...
            <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                    ...
                    <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <button className="text-xs text-primary hover:text-opacity-80">
                                    View More
                                </button>
                                <button className="text-xs text-red-600 hover:text-opacity-80">
                                    Delete
                                </button>
                            </div>
                        </div>
                        <div className="h-80 bg-gray-50 dark:bg-gray-800 rounded p-4">
                ...
                <div className="col-span-12 xl:col-span-4">
                    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                        ...
                        <div className="mb-4">
                            <div className="flex items-center gap-2 text-xs font-medium text-green-600 mb-4">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-xs font-medium text-black dark:text-white">$20K</span>
                            </div>
                            <div className="flex items-center justify-between">
            ...
            <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                    ...
                    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex items-center gap-4 mb-4">
                                <button className="text-xs font-medium text-primary">Overview</button>
                                <button className="text-xs font-medium text-gray-600 dark:text-gray-400">Sales</button>
                                <button className="text-xs font-medium text-gray-600 dark:text-gray-400">Revenue</button>
                            </div>
                        </div>
                        <div className="h-80 bg-gray-50 dark:bg-gray-800 rounded p-4">
                            <LineChart data={revenueTrendData} title="Statistics" />
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-12 xl:col-span-5">
                    <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6">
                        ...
                        <div className="border-gray-200 my-6 overflow-hidden rounded-2xl border bg-gray-50 px-4 py-6 dark:border-gray-800 dark:bg-gray-900 sm:px-6">
                            <div className="h-[212px] w-full">
                                <DoughnutChart data={customerDemographicsData} title="Customer Demographics" />
                            </div>
                        </div>
                        <div className="space-y-5">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-full max-w-8 items-center rounded-full">
                                        <img src="/assets/images/country-01.svg" alt="usa" />
                                    </div>
                                    <div>
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className="w-full max-w-8 items-center rounded-full">
                                        <img src="/assets/images/country-02.svg" alt="france" />
                                    </div>
                                    <div>
                                        <p className="text-xs font-semibold text-gray-800 dark:text-white/90">
                                            France
                                        ...
                                        <td className="px-4 py-3 xl:pl-6">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-gray-500 dark:text-gray-400">{order.variants}</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-4 py-3">
                                            <p className="text-xs text-black dark:text-white">{order.category}</p>
                                        </td>
                                        <td className="px-4 py-3">
                                            <p className="text-xs font-medium text-black dark:text-white">{order.price}</p>
                                        </td>
                                        <td className="px-4 py-3">
                                            <span className={`inline-flex rounded-full bg-opacity-10 px-2 py-1 text-xs font-medium ${order.statusColor}`}>
                                                {order.status}
                                            </span>
                                        </td>
                                    </tr>
