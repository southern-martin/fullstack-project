...
import (
	...
	"github.com/southern-martin/go-app-api/internal/middleware"
	"github.com/southern-martin/go-app-api/internal/modules/carrier/router"
	"github.com/southern-martin/go-app-api/internal/modules/users"
	"github.com/southern-martin/go-app-api/internal/modules/users/handler"
	usersRouter "github.com/southern-martin/go-app-api/internal/modules/users/router"
...
func (r *Router) setupHealthCheck(router *gin.Engine) {
	router.GET("/health", func(c *gin.Context) {
		c.JSON(http.StatusOK, gin.H{
			"status":    "ok",
			"service":   "github.com/southern-martin/go-app-api-api",
			"version":   "1.0.0",
