...
import (
	...
	"github.com/southern-martin/go-app-api/internal/infrastructure/database"
	"github.com/southern-martin/go-app-api/internal/modules"
	"github.com/southern-martin/go-app-api/internal/modules/users/handler"
	"github.com/southern-martin/go-app-api/internal/modules/users/model"
	"github.com/southern-martin/go-app-api/internal/modules/users/repository"
	"github.com/southern-martin/go-app-api/internal/modules/users/router"
	"github.com/southern-martin/go-app-api/internal/modules/users/service"
...
func (m *UsersModule) Initialize(db *database.Database, logger *logrus.Logger) error {
	...
	m.userRepo = repository.NewUserRepository(db.DB)
	m.roleRepo = repository.NewRoleRepository(db.DB)
...
func (m *UsersModule) GetHandlers() []modules.Handler {
