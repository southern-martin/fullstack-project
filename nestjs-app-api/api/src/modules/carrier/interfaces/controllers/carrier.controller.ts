...
export class CarrierController {
  ...
  ): Promise<CarrierResponseDto[] | { carriers: CarrierResponseDto[]; total: number; page: number; limit: number }> {
    if (page && limit) {
   ...
   */
  @Get(':id')
  async getById(@Param('id', ParseIntPipe) id: number): Promise<CarrierResponseDto> {
