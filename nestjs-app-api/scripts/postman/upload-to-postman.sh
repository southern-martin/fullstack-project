...
# File paths
readonly COLLECTION_FILE_NAME="postman-collection.json"
readonly ENVIRONMENT_FILE_NAME="postman-environment.json"
...
show_usage() {
    ...
    echo ""
    echo "Upload NestJS API Postman collection and environment to cloud workspace."
    echo ""
    echo "Arguments:"
    ...
    echo "  - postman-collection.json (unified collection with translation support)"
    echo "  - postman-environment.json (environment variables)"
    echo ""
...
main() {
    # Show header
    print_info "NestJS API Postman Upload Script v2.0"
    echo "=========================================="
    echo "This will upload the unified collection and environment to Postman"
    echo "Collection includes: API endpoints + Translation testing support"
    echo ""
