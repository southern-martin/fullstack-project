...
exports.LanguageValueTypeOrmEntity = void 0;
var typeorm_1 = require("typeorm");
var language_typeorm_entity_1 = require("./language.typeorm.entity");
var LanguageValueTypeOrmEntity = function () {
    var _classDecorators = [(0, typeorm_1.Entity)("language_values"), (0, typeorm_1.Index)(["key"], { unique: true }), (0, typeorm_1.Index)(["languageCode"]), (0, typeorm_1.Index)(["isApproved"]), (0, typeorm_1.Index)(["createdAt"]), (0, typeorm_1.Index)(["usageCount"])];
    ...
    var LanguageValueTypeOrmEntity = _classThis = /** @class */ (function () {
        function LanguageValueTypeOrmEntity_1() {
            ...
            this.key = (__runInitializers(this, _updatedAt_extraInitializers), __runInitializers(this, _key_initializers, void 0)); // MD5 hash of the original text
            this.languageCode = (__runInitializers(this, _key_extraInitializers), __runInitializers(this, _languageCode_initializers, void 0)); // Language code reference (e.g., 'en', 'es', 'fr') - matches old system
            ...
            this.original = (__runInitializers(this, _language_extraInitializers), __runInitializers(this, _original_initializers, void 0)); // Original text in source language (renamed from originalText to match old system)
            this.destination = (__runInitializers(this, _original_extraInitializers), __runInitializers(this, _destination_initializers, void 0)); // Translated text (renamed from translatedText to match old system)
            this.context = (__runInitializers(this, _destination_extraInitializers), __runInitializers(this, _context_initializers, void 0));
            this.isApproved = (__runInitializers(this, _context_extraInitializers), __runInitializers(this, _isApproved_initializers, void 0));
            this.approvedBy = (__runInitializers(this, _isApproved_extraInitializers), __runInitializers(this, _approvedBy_initializers, void 0)); // User ID who approved the translation
            ...
            this.usageCount = (__runInitializers(this, _approvedAt_extraInitializers), __runInitializers(this, _usageCount_initializers, void 0)); // How many times this translation has been used
            ...
            __runInitializers(this, _lastUsedAt_extraInitializers);
        }
        return LanguageValueTypeOrmEntity_1;
    }());
    __setFunctionName(_classThis, "LanguageValueTypeOrmEntity");
    (function () {
        ...
        _key_decorators = [(0, typeorm_1.Column)({ unique: true, length: 32 })];
        _languageCode_decorators = [(0, typeorm_1.Column)({ length: 5 })];
        _language_decorators = [(0, typeorm_1.ManyToOne)(function () { return language_typeorm_entity_1.LanguageTypeOrmEntity; }), (0, typeorm_1.JoinColumn)({ name: "languageCode", referencedColumnName: "code" })];
        _original_decorators = [(0, typeorm_1.Column)({ type: "text" })];
        _destination_decorators = [(0, typeorm_1.Column)({ type: "text" })];
        _context_decorators = [(0, typeorm_1.Column)({ type: "json", nullable: true })];
        _isApproved_decorators = [(0, typeorm_1.Column)({ default: false })];
        _approvedBy_decorators = [(0, typeorm_1.Column)({ nullable: true, length: 50 })];
        ...
        LanguageValueTypeOrmEntity = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return LanguageValueTypeOrmEntity = _classThis;
}();
exports.LanguageValueTypeOrmEntity = LanguageValueTypeOrmEntity;
